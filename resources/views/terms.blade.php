<x-guest-layout>
    ...
    <div class="container">
        ...
        <h2>アカウント</h2>
        <p>ユーザーは、アカウントを作成し、管理する責任を負います。アカウント情報の不正使用による損害について、当サイトは一切責任を負いません。アカウント作成には、ユーザー名、メールアドレス、パスワードが必要です。</p>

        <h2>エピソードの投稿</h2>
        <p>ユーザーは、当サイトを通じてチーム内で予定を共有することができます。予定に関する事項は、当サイトの利用規約およびガイドラインに従うものとします。</p>
