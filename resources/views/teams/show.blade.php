<x-app-layout>
    <x-slot name="header">
        <div class="flex justify-between items-center">
            ...
            <form method="POST" action="{{ route('teams.leave') }}">
                @csrf
                <button type="submit" class="bg-red-500 text-white px-4 py-2 rounded-md hover:bg-red-600">チームを離脱</button>
            </form>
        </div>
    </x-slot>
    ...
    <div id="eventDetailModal" class="fixed inset-0 flex items-center justify-center bg-gray-800 bg-opacity-75 hidden z-50">
        <div class="bg-white p-6 rounded shadow-lg w-full max-w-lg">
    ...
    <div id="dayModal" class="fixed inset-0 flex items-center justify-center bg-gray-800 bg-opacity-75 hidden z-50">
        <div class="bg-white p-6 rounded shadow-lg w-full max-w-lg">
